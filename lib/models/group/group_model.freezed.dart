...
abstract class $GroupModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String gid, List<String> participants});
}
...
class _$GroupModelImpl implements _GroupModel {
  _$GroupModelImpl(
      {required this.gid, required final List<String> participants})
  ...
  @override
  String toString() {
    return 'GroupModel(gid: $gid, participants: $participants)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, gid, const DeepCollectionEquality().hash(_participants));
...
abstract class _GroupModel implements GroupModel {
  factory _GroupModel(
      ...
      required final List<String> participants}) = _$GroupModelImpl;
